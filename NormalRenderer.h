	...
	void RenderScene (void)
	{
		if (m_pScene)
		{
			...
			for (unsigned int n = 0; n < numObjs; n++)
			{
				...
				{
					// Set the Material
					SceneMaterial *sceneMat = ((SceneSphere *)sceneObj)->material;// m_pScene->GetMaterial(((SceneSphere *)sceneObj)->material);
				...
				else if (sceneObj->IsTriangle ())
				{
					...
					SceneMaterial *sceneMat = ((SceneTriangle *)sceneObj)->material[0]; // m_pScene->GetMaterial(((SceneTriangle *)sceneObj)->material[0]);
					glMaterialfv (GL_FRONT_AND_BACK, GL_SPECULAR, (GLfloat *)&sceneMat->specular);
					glMaterialf(GL_FRONT, GL_SHININESS, sceneMat->shininess);
					...
					sceneMat = ((SceneTriangle *)sceneObj)->material[0]; // m_pScene->GetMaterial(((SceneTriangle *)sceneObj)->material[0]);
					glColor3fv ((GLfloat *)&sceneMat->diffuse);
					...
					sceneMat = ((SceneTriangle *)sceneObj)->material[1]; // m_pScene->GetMaterial(((SceneTriangle *)sceneObj)->material[1]);
					glColor3fv ((GLfloat *)&sceneMat->diffuse);
					...
					sceneMat = ((SceneTriangle *)sceneObj)->material[2]; // m_pScene->GetMaterial(((SceneTriangle *)sceneObj)->material[2]);
					glColor3fv ((GLfloat *)&sceneMat->diffuse);
				...
				else if (sceneObj->IsModel ())
				{
					...
					SceneMaterial *sceneMat = ((SceneModel *)sceneObj)->GetTriangle(0)->material[0]; // m_pScene->GetMaterial(((SceneModel *)sceneObj)->GetTriangle(0)->material[0]);
					glColor3fv ((GLfloat *)&sceneMat->diffuse);
					glMaterialfv (GL_FRONT_AND_BACK, GL_SPECULAR, (GLfloat *)&sceneMat->specular);
					glMaterialf(GL_FRONT, GL_SHININESS, sceneMat->shininess);
